...
public class CleansingCategory extends AbstractSpellCategory<RecipeCleansing> {
    public CleansingCategory(IGuiHelper helper) {
        super(helper, "gui.arcane.jei.cleansing", ArcaneJeiPlugin.CLEANSING);
    }

    @Override
    protected Ingredient getInput(RecipeCleansing recipe) {
        return recipe.input;
    }

    @Override
    protected List<RecipeOutput> getResults(RecipeCleansing recipe) {
