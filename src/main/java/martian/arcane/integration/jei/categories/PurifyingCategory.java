...
public class PurifyingCategory extends AbstractSpellCategory<RecipePurifying> {
    public PurifyingCategory(IGuiHelper helper) {
        super(helper, "gui.arcane.jei.purifying", ArcaneJeiPlugin.PURIFYING);
    }

    @Override
    protected Ingredient getInput(RecipePurifying recipe) {
        return recipe.input;
    }

    @Override
    protected List<RecipeOutput> getResults(RecipePurifying recipe) {
