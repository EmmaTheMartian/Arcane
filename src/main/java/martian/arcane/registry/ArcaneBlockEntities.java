...
public class ArcaneBlockEntities extends ArcaneRegistry {
    ...
    public static final RegistryObject<BlockEntityType<BlockEntityAuraInserter>> AURA_INSERTER_BE = BLOCK_ENTITIES.register("be_aura_inserter", () ->
            BlockEntityType.Builder.of(BlockEntityAuraInserter::new, ArcaneBlocks.AURA_INSERTER.get()).build(null));

    public static final RegistryObject<BlockEntityType<BlockEntityAuraBasin>> AURA_BASIN_BE = BLOCK_ENTITIES.register("be_aura_basin", () ->
            BlockEntityType.Builder.of(BlockEntityAuraBasin::new, ArcaneBlocks.AURA_BASIN.get()).build(null));
}
