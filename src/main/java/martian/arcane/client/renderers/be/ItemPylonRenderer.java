...
public class ItemPylonRenderer implements BlockEntityRenderer<BlockEntityItemPylon> {
    public ItemPylonRenderer(BlockEntityRendererProvider.Context ignored) {
    }

    @Override
    @ParametersAreNonnullByDefault
    public void render(BlockEntityItemPylon infuser, float partialTick, PoseStack ps, MultiBufferSource buffer, int light, int overlay) {
