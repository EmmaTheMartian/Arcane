...
public class AuraInfusionType implements ArcaneRecipeType<RecipeAuraInfusion> {
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, RecipeAuraInfusion> STREAM_CODEC = StreamCodec.of(AuraInfusionType::toNetwork, AuraInfusionType::fromNetwork);
